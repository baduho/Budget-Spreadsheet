...
while(Restart == "Y"):
    ...
    #PLOTTING THE CHART (The follwing block of code where we are plotting the chart isn't written by us. We copied some code that we modified to suit our use)
    #The link to the source can be found in our final report on Quercus
    c1 = LineChart()
    c1.title = "Balance"
